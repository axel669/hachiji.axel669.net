(function () {
    ...
    class Ripple extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$p, create_fragment$r, safe_not_equal, { color: 0, disabled: 5 }, add_css$h);
    	}
    }
    ...
    class Adornment extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$o, create_fragment$q, safe_not_equal, { flush: 0 }, add_css$g);
    	}
    }
    ...
    class Baseline extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, null, create_fragment$o, safe_not_equal, {}, add_css$f);
    	}
    }
    ...
    class Icon extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$l, create_fragment$m, safe_not_equal, { name: 3, size: 4 }, add_css$d);
    	}
    }
    ...
    class Modal extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$k, create_fragment$k, safe_not_equal, { open: 0, clear: 1, persistent: 4 }, add_css$c);
    	}
    }
    ...
    class Control_drawer extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$j, create_fragment$j, safe_not_equal, { open: 0, persistent: 1 }, add_css$b);
    	}
    }
    ...
    class Option_list extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$h, create_fragment$h, safe_not_equal, { color: 0, variant: 1, square: 2, info: 6 }, add_css$9);
    	}
    }
    ...
    class Title_bar extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$f, create_fragment$f, safe_not_equal, { sticky: 0, center: 1, compact: 2 }, add_css$7);
    	}
    }
    ...
    class Confirm extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { close: 7, options: 8 });
    	}
    }
    ...
    class Prompt extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { close: 11, options: 12 }, add_css$1);
    	}
    }
    ...
    function add_css(target) {
    	append_styles(target, "svelte-178pjv", "time-text.svelte-178pjv{font-size:24px}tz-selected.svelte-178pjv{text-align:center}");
    }

    // (75:4) <TitleBar compact>
    ...
    // (78:8) <Adornment slot="menu">
    function create_default_slot_5$1(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*zone*/ ctx[0] !== null && create_if_block_2(ctx);
    ...
    // (87:12) <Button color="danger" on:tap={remove}>
    ...
    function create_selected_slot$1(ctx) {
    	...
    	let br;
    	let t1;
    	let t2_value = (/*selected*/ ctx[14]?.name ?? "") + "";
    	let t2;
    	...
    	return {
    		c() {
    			...
    			set_custom_element_data(tz_selected, "class", "svelte-178pjv");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*selected*/ 16384 && t2_value !== (t2_value = (/*selected*/ ctx[14]?.name ?? "") + "")) set_data(t2, t2_value);
    		},
    		d(detaching) {
    ...
    function create_default_slot_2$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			set_custom_element_data(time_text, "class", "svelte-178pjv");
    		},
    		m(target, anchor) {
    ...
    function create_default_slot$1(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, zone, name*/ 32771) {
    				titlebar_changes.$$scope = { dirty, ctx };
    			}
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, display, zone, name*/ 32787) {
    				paper_changes.$$scope = { dirty, ctx };
    			}
    ...
    class Clock extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { zone: 0, name: 1, id: 7 }, add_css);
    	}
    }
    ...
    class Theme_selector extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { currentTheme: 0 });
    	}
    }
    ...
    // (53:8) <Button color="primary" on:tap={addClock} variant="outline">
    ...
    // (59:12) {#each $clocks as {zone, name, id}}
    ...
    // (57:8) <Grid cols={2} padding="0px" gap="4px">
    ...
    // (52:4) <Flex direction="column" padding="2px">
    ...
    // (43:0) <Paper width="min(100%, 720px)" center>
